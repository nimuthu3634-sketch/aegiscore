...
import { BrandHero } from "@aegiscore/ui";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      <div className="grid w-full max-w-5xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <BrandHero
          title="Triage alerts faster, keep incidents coherent, and explain every risk decision."
          description="AegisCore brings together defensive telemetry, analyst workflows, live updates, and explainable scoring for small and medium organizations."
        >
          {[
        ...
        <Card className="self-center">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-2xl border bg-[#fff8f1] p-4 text-sm text-[var(--muted)]">
              Default demo accounts are seeded by the backend: {authDemoUsers.join(", ")}.
            </div>
          </CardContent>
        </Card>
      </div>
